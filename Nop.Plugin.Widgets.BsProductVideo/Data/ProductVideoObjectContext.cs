...
namespace Nop.Plugin.Widgets.BsProductVideo.Data
{
    ...
    /// </summary>
    public class ProductVideoObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public ProductVideoObjectContext(DbContextOptions<ProductVideoObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new ProductVideoRecordMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(ProductVideoRecord));
        }
